...
simulation_parameter_2 = [2, 4, 5]
simulation_parameter_3 = [0, 0.5, 1.0, 1.5]
simulation_parameter_4 = [False, True]"""


"""simulation_parameter_1 = [6, 7, 8]
simulation_parameter_2 = [2, 4, 5]
simulation_parameter_3 = [0, 0.5, 1.0, 1.5, 2]
simulation_parameter_4 = [False, True]"""

simulation_parameter_1 = [3, 4]
...
workbook = xlsxwriter.Workbook('Results_V2.xlsx')
